    ...
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <div className='bloc lg:flex text-center items-center justify-center mb-8 w-full'>
        <div className='flex items-center justify-center mb-4 w-full lg:mb-0 lg:w-auto mr-8'>
          ...
          />
          <p className='inline align-midlle text-gray-700 ml-2 text-lg'>{post.author.name}</p>
        </div>
      ...
      <p className='text-center text-lg text-gray-700 font-normal px-4 lg:px-20 mb-8'>{post.excerrpt}</p>
